...
namespace ProjectPOO {
	...
	/// <summary>
	/// Description résumée de MyFormCommandeCreer
	/// </summary>
	public ref class MyFormCommandeCreer : public System::Windows::Forms::Form
	{
	public:
		MyFormCommandeCreer(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->lbCreer->Size = System::Drawing::Size(1338, 48);
			...
			this->btnOK->Click += gcnew System::EventHandler(this, &MyFormCommandeCreer::btnOK_Click_1);
			// 
			// btnAnnuler
			// 
			...
			this->btnAnnuler->Click += gcnew System::EventHandler(this, &MyFormCommandeCreer::btnAnnuler_Click_1);
			// 
			// txtTotalArticle
			// 
			...
			this->Name = L"MyFormCommandeCreer";
			this->Text = L"MyFormCommandeCreer";
			this->Load += gcnew System::EventHandler(this, &MyFormCommandeCreer::MyFormCommandeCreer_Load_1);
...
#pragma endregion
	...
	private: System::Void MyFormCommandeCreer_Load_1(System::Object^ sender, System::EventArgs^ e) {
	...
	private: System::Void btnOK_Click_1(System::Object^ sender, System::EventArgs^ e) {
		...
		else
		{
			...
			this->oSvc->AjouterCommande(this->txtCommandeID->Text, this->txtDatePrevision->Text, this->txtDateEmission->Text, this->txtDateReception->Text, this->txtMontantHT->Text, this->txtMontantTTC->Text, this->txtMontantTVA->Text, this->txtDateEmissionFacture->Text, this->txtMoyenPaiement->Text, this->txtDatePaiement->Text, TotalArticle, PersonnelID, SocieteID);
